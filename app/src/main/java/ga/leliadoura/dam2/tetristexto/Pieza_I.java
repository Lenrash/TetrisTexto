...
public class Pieza_I extends Pieza {
    ...
    public char[][] generar(int estado){
        switch (estado) {
            case 0:
                pieza[0][0] = 'I';	pieza[0][1] = ' ';	pieza[0][2] = ' ';	pieza[0][3] = ' ';
                pieza[1][0] = 'I';	pieza[1][1] = ' ';	pieza[1][2] = ' ';	pieza[1][3] = ' ';
                pieza[2][0] = 'I';	pieza[2][1] = ' ';	pieza[2][2] = ' ';	pieza[2][3] = ' ';
                pieza[3][0] = 'I';	pieza[3][1] = ' ';	pieza[3][2] = ' ';	pieza[3][3] = ' ';
            ...
            case 1:
                ...
                pieza[1][0] = ' ';	pieza[1][1] = ' ';	pieza[1][2] = ' ';	pieza[1][3] = ' ';
